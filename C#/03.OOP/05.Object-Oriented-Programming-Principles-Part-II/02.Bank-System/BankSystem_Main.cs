...
namespace _02.Bank_System
{
    class BankSystem_Main
    {
        static void Main()
        {
            DepositAcc da = new DepositAcc(new Individual("eryutdu", 24, "7810220982"), 2363.52M, 2.3M);
            Customer cust = new Individual("eryutdu", 24, "7810220982");
            Customer cust1 = new Company("Teleric", "7894561231598");

            da.WithdrawMoney(56);
            Console.WriteLine(da.Balance);
            da.DepositMoney(34);
            Console.WriteLine(da.Balance);
            Console.WriteLine(da.InterestInMonths(12));
        }
    }
}