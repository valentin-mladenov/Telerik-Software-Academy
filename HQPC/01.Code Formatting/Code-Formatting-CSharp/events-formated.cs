...
class Event : IComparable //I think this class is better to be in a different file, but din't move it.
{
	private DateTime date; // properties changed from public to private.
...
class Program
{
	...
	static EventHolder events = new EventHolder(); // moved from th middle of the code.

	static class Messages //I think this class is better to be in a different file, but din't move it.
	{
		public static void EventAdded()
		{
			// output.Append("Event added\n"); Original bottom formated
	...
	class EventHolder //I think this class is better to be in a different file, but din't move it.
	{
	...
	static void Main(string[] args) // moved from th middle of the code.
	{
