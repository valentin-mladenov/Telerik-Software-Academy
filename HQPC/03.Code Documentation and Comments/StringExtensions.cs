...
namespace Telerik.ILS.Common
{
    ...
    public static class StringExtensions
    {
		...
		/// </summary>
		/// <param name="input">The string whose hash method computes.</param>
		/// <example>This sample shows how to call the <see cref="ToMD5Hash"/> method.
		/// <code>
		/// class TestClass
		/// {
		///		static void Main()
		...
		/// </code>
		/// </example>
		/// <returns>The 128-bit (16-byte) hash of string.</returns>
